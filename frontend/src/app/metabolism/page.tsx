  ...
  return (
    <ErrorBoundary fallbackTitle="Metabolism module failed to render">
      <div className="page-panel">
        ...
        {stressCompareResult && (
          <div className="glass-panel mb-2 flex flex-col md:flex-row justify-between items-center gap-4 border-accent/20">
            <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          <div className="lg:col-span-5 glass-panel overflow-hidden h-[450px]">
