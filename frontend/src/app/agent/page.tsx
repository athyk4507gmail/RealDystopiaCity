  ...
  const [messages, setMessages] = useState<ChatTurn[]>([
    {
      role: "assistant",
      content:
        "I'm the Civic Agent. I only answer from real tool calls against DystopiaCITY data — Health Watch, Water, Traffic, Metabolism, Trust Score, Risk Zones, and civic knowledge search. Ask a concrete question about a ward or area.",
    },
  ]);
    ...
    <div className="flex h-full min-h-0 flex-col">
      <header className="border-b border-border px-6 py-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-semibold">Civic Agent</h1>
      ...
      <div className="border-t border-border p-4">
        <div className="mx-auto flex max-w-3xl gap-2">
          <input
            ...
            className="flex-1 rounded-lg border border-border bg-black/30 px-4 py-3 text-sm outline-none focus:border-accent"
            disabled={loading}
          />
          <button
            type="button"
            ...
            className="rounded-lg bg-accent px-4 py-3 text-black font-medium disabled:opacity-40 hover:bg-accent-dim"
          >
