...
async def test_rag_retrieves_specific_complaint(db, ward_name):
    ...
    created = await execute_tool(
        ...
        "file_complaint",
        {
            ...
            "description": "Unique indigo dye contamination near civic agent fountain",
        },
    )
    ...
    result = search_civic_knowledge(db, "indigo dye contamination civic agent fountain")
    assert result["ok"] is True
    ...
    plan = [
        {
            "action": "call_tool",
            "tool": "search_civic_knowledge",
            "params": {"query": "indigo dye contamination civic agent fountain"},
