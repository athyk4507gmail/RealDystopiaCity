...
def test_water_planning_fallback_routes_explicitly_not_by_ward_data_keyword():
    ...
    generic = service._fallback("system", health_watch_prompt, json_mode=False, fallback_type=None)
    ...
    water_json = service._fallback("system", water_prompt, json_mode=True, fallback_type="water_planning")
